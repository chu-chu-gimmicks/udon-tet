...
namespace ChuChuGimmicks.UDONTET
{
    public partial class Main
    {
        ...
        // Game Over
        private const float _UIM_GAME_OVER_DELAY = 2.5f;

        // Reset Button
        private readonly Vector3[] _UIM_RESET_BUTTON_POS = { new Vector3(0, 0, 0), new Vector3(0, 0, -50.2f) };
        private readonly string[]  _UIM_RESET_BUTTON_STR  = { "PLAY", "CONTINUE", "BACK TO TITLE" };





        private void UIM_Reset()
        {
        ...
        private void UIM_OnGameOver()
        {
            ...
            SendCustomEventDelayedSeconds(nameof(_UIM_OnGameOverDelay), _UIM_GAME_OVER_DELAY);
        ...
        public void _UIM_OnGameOverDelay()
        {
        ...
        {
            guide.sharedMaterial = guideMaterials[(Networking.LocalPlayer.IsUserInVR()) ? 0 : 1];
        }
    }
}
