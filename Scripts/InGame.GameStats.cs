...
namespace ChuChuGimmicks.UDONTET
{
    ...
    {
        private const byte STT_MAX_LEVEL = 26;
        private const byte STT_THRESHOLD_LEVEL = 20;
        ...
        private bool STT_NeedsLevelUp()
        {
            ...
            {
                int baseLines = STT_THRESHOLD_LEVEL * STT_LINES_PER_LEVEL_BASE;
                int extraLevels = STT_Level - STT_THRESHOLD_LEVEL;
